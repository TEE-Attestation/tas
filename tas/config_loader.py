...
KNOWN_TAS_KEYS = {
    ...
    "TAS_CERTIFY_ENABLED",
    "TAS_CERT_PLUGIN",
    "TAS_CERT_PLUGIN_PREFIX",
    "TAS_CERT_CONFIG_FILE",
    "TAS_CERT_VALIDITY_SECONDS",
    "TAS_CERT_CLOCK_SKEW_SECONDS",
    "TAS_CERT_TRUST_DOMAIN",
    "TAS_CERT_MAX_CSR_BYTES",
    "TAS_CERT_EVIDENCE_DIGEST_MAX_ENTRIES",
    "TAS_CERT_EVIDENCE_DIGEST_MAX_BYTES",
    "TAS_CERT_ALLOWED_KEY_TYPES",
    "TAS_CERTIFY_MAX_POLICIES",
    "TAS_OID_ROOT",
